...
from event_scraping.spiders.community_social.bhf_spider import BHFSpider
...
if __name__ == "__main__":
    ...
    print(f"Running {BHFSpider.__name__} spider")
    print(f"Spider name: {BHFSpider.name}")
