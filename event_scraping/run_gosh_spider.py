...
from event_scraping.spiders.community_social.gosh_spider import GOSHSpider
...
if __name__ == "__main__":
    ...
    print(f"Running {GOSHSpider.__name__} spider")
    print(f"Spider name: {GOSHSpider.name}")
